...
const ConsoleOutput = () => {
  ...
  return (
    <div className="bg-gray-800 text-white p-3 w-full max-w-4xl h-full max-h-[540] min-h-[300px] overflow-y-auto font-mono rounded-md border border-gray-700 flex flex-col">
